    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Terminologies", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TulMovements", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TulMovements_Movements_MovementId",
                        column: x => x.MovementId,
                        principalTable: "Movements",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TulMovements_Tuls_TulId",
                        column: x => x.TulId,
                        principalTable: "Tuls",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Terminologies_CategoryId",
                table: "Terminologies",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_TulMovements_MovementId",
                table: "TulMovements",
                column: "MovementId");

            migrationBuilder.CreateIndex(
                name: "IX_TulMovements_TulId",
                table: "TulMovements",
                column: "TulId");
